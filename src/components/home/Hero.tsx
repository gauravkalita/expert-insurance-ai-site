        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6 animate-fade-in">
            <h1 className="font-montserrat font-bold text-4xl md:text-5xl lg:text-6xl leading-tight text-gray-900">
              Insurance Expertise, <span className="text-primary">Simplified</span>
            </h1>
            <p className="text-lg md:text-xl text-gray-700 max-w-xl">
              Your AI-powered hub for insurance insights, tools, and expert guidance to make better decisions for your future.
            </p>
            ...
            <div className="pt-6">
              <p className="text-sm text-gray-600">Trusted by thousands of users for insurance guidance</p>
              <div className="flex items-center gap-1 mt-2">
                ...
                <span className="text-gray-700 font-medium ml-2">4.9/5 from 800+ users</span>
              </div>
            </div>
          </div>
